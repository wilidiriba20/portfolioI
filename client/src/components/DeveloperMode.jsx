...
const TERM_DATA = {
  ...
  help: [
    ...
    { cls: "text-zinc-300", t: "  about      →  Tells about the developer" },
    { cls: "text-zinc-300", t: "  skills     →  Displays technical skills" },
    { cls: "text-zinc-300", t: "  projects   →  Shows projects" },
    { cls: "text-zinc-300", t: "  contact    →  Displays contact information" },
